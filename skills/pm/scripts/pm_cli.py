...
def build_parser(*, handlers: dict[str, Any]) -> argparse.ArgumentParser:
    ...
    start_work = sub.add_parser("start-work")
    start_work.add_argument("--task-id", default="")
    start_work.add_argument("--task-guid", default="")
    start_work.add_argument("--summary", default="")
    start_work.add_argument("--request", default="")
    start_work.add_argument("--repo-root", default="")
    start_work.add_argument("--kind", default="")
    start_work.add_argument("--tasklist-name", default="")
    start_work.add_argument("--force-new", action="store_true", default=False)
    start_work.add_argument("--comment", default="")
    start_work.add_argument("--no-comment", action="store_true", default=False)
    start_work.add_argument("--no-run", action="store_true", default=False)
    start_work.add_argument("--reviewed", action="store_true", default=False)
    start_work.add_argument("--backend", default="")
    start_work.add_argument("--agent", default="")
    start_work.add_argument("--timeout", type=int, default=0)
    start_work.add_argument("--thinking", default="")
